...
function Showcase3() {
  return (
    <div className="tablet:flex">
      ...
      ></div>
      <div className="bg-[#F1F1F1] rounded-lg px-6 py-10 tablet:px-10 desktop:px-[95px] mt-6 tablet:mt-0 ml-3 tablet:w-[50%] tablet:flex tablet:flex-col tablet:justify-center">
